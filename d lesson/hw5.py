...
if c == 1:
    ...
    if a == 2:    
        print(Diluc.WhoAmI)
    if a == 3:    
        print("I am", Diluc.Get_Age, "years old")
    if a == 4:    
        print("My catchprase is ", Diluc.Talk("'We should prepare while we can, then make a preemtive strike against the enemy'"))
    if a == 5:    
        print("My idle action is ", Diluc.Idle("catching my owl"))
    if a == 6:
    ...
    if a == 1:
        print(Eula.WhoAmI)
    if a == 2:
        print("My full name is ", Eula.Get_name, Eula.Get_surname)
    if a == 3:
        print("I am", Eula.Get_Age, "years old")
    if a == 4:
        print("My catchprase is ", Eula.Talk("'Aristocratic etiquette is all just for show.. just smile and nod along! I was forced to learn all the rules my heart, but even I don't tke them that seriosly'"))   
    if a == 5:
        print("My idle action is ", Eula.Idle("creating a big snowflake"))
    if a == 6:
    ...
    if a == 1:
        print(Ayaka.WhoAmI)
    if a == 2:
        print("My full name is ", Ayaka.Get_name, Ayaka.Get_surname)
    if a == 3:
        print("I am", Ayaka.Get_Age, "years old")
    if a == 4:
        print("My catchprase is ", Ayaka.Talk("'a blade is like a tea-leaf. Only those who sample it many times can appreciate its true qualities'"))  
    if a == 5:
        print("My idle action is ", Ayaka.Idle("touching my sword and explaining its assignment"))
    if a == 6:
...
if c == 4:
    ...
    if a == 1:
        print(Kazuha.WhoAmI)
    if a == 2:
        print("My full name is ", Kazuha.Get_name, Kazuha.Get_surname)
    if a == 3:
        print("I am", Kazuha.Get_Age, "years old")
    if a == 4:
        print("My catchprase is ", Kazuha.Talk("'Whenever in this this world i roam, I carry memory of my home.. This blade.. It is the last thing I have to the land of my birth'"))   
    if a == 5:
        print("My idle action is ", Kazuha.Idle("catching a leaf and making music on it")) 
    if a == 6:
...
if c == 5:
    ...
    if a == 1:
        print(Scara.WhoAmI)
    if a == 2:
        print("My full name is ", Scara.Get_name, Scara.Get_surname)
    if a == 3:
        print("I am", Scara.Get_Age, "years old")
    if a == 4:
        print("My catchprase is ", Scara.Talk("'There's no such thing as pure freedom in this world. Even the wind cannot blow on forever'"))
    if a == 5:
        print("My idle action is ", Scara.Idle("moking threatening  by an anemo elemental sphere"))
    if a == 6:
        print(Scara.Get_name, Scara.Attack)    
    if a == 7:
...
if c == 6:
    ...
    if a == 2:
        print("My full name is ", LaSignora.Get_name, LaSignora.Get_surname)
    if a == 3:
        print("I am", LaSignora.Get_Age, "years old")
    if a == 4:
        print("My catchprase is ", LaSignora.Talk("'Haha, you're trembling.. is it the cold, or just cowardice?'"))  
    if a == 5:
        print("My idle action is ", LaSignora.Idle("standing while my catalyst is levitating near me"))
    if a == 6:
        print(LaSignora.Get_name, LaSignora.Attack)    
    if a == 7:
...
if c == 7:
    ...
    if a == 5:
        print("My idle action is ", Zhongli.Idle("thoughtfully standinf and potating a mini comet around myself"))
    if a == 6:
        print(Zhongli.Get_name, Zhongli.AttackS)    
    if a == 7:
...
if c == 8:
    ...
    if a == 5:
        print("My idle action is ", Venti.Idle("levitating and creating an anemo elemental sphere"))  
    if a == 6:
...
if c == 9:
    ...
    if a == 2:
        print("My full name is ", Katheryne.Get_name, Katheryne.Get_surname)
    if a == 3:
        print("I am", Katheryne.Get_Age, "years old")
    if a == 4:
        print("My catchprase is ", Katheryne.Talk("'Ad astra abyssoque! Welcime to the Adventures's Guild'"))     
    if a == 5:
        print("My idle action is ", Katheryne.Idle("just standing"))    
    if a == 6:
